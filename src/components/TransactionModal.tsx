...
export function TransactionModal({ isOpen, onClose, defaultType = 'expense', transactionToEdit = null }: TransactionModalProps) {
  ...
  return (
    <SidePanel
      ...
      subtitle={transactionToEdit ? `Last updated ${format(new Date(transactionToEdit.date), 'MMM d, yyyy')}` : 'Record income or expense'}
      footer={
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-2">
            ...
            <button type="submit" form="transaction-form" className="btn-primary">Save Transaction</button>
          </div>
        </div>
      }
    >
